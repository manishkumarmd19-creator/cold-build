          ...
          {projects.map((project, i) => (
            ...
            >
              <TiltCard className="relative rounded-2xl overflow-hidden cursor-pointer h-full">
                <div className="aspect-[16/10] bg-dark-slate relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-rich-charcoal via-transparent to-transparent" />
                  <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                    <span className="text-premium-gold/80 text-xs tracking-widest uppercase">
                      {project.category}
                    </span>
                    <h3 className="text-2xl font-bold text-white mt-1 mb-2">{project.title}</h3>
                    <p className="text-light-gray/60 text-sm">{project.desc}</p>
                  </div>
