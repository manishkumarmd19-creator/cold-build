      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-premium-gold/10 to-emerald/10 border border-white/5 p-8 flex items-center justify-center">
            ...
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-premium-gold/10 rounded-full blur-2xl" />
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-emerald/10 rounded-full blur-2xl" />
          </motion.div>
        </div>
      </div>
    </section>
